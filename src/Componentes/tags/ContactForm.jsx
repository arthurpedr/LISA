...
function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch("https://formspree.io/f/mblkdkqp", {
      method: "POST",
      body: formPayload,
      headers: {
  ...
  return (
    <form
      ...
      className="w-[90vw] md:w-[500px] h-auto flex flex-col items-center justify-center gap-[20px]"
    >
      {/* Campo Nome */}
      ...
      <button
        type="submit"
        className="w-full h-[55px] bg-[#5F45FF] rounded-[8px] text-[#EFECFF] font-[700] cursor-pointer hover:bg-transparent hover:border border-[#5F45FF] hover:text-[#5F45FF] transition-all duration-300"
      >
        Enviar Mensagem
      </button>
