...
export default function InfoCard({ iconSrc, title, description }) {
  return (
    ...
    initial={{ opacity: 0, y: 80 }}
     ...
     className="text-[#EFECFF] bg-[#17181A] w-[405px] h-[262px] flex flex-col justify-center gap-[32px] border-2 border-[#5F45FF] rounded-[10px] px-10 transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-lg">
